...
class Mysql_data(Mysql_connet):
    def __init__(self):
        random_num = faker.random_number(20)
        self.user_id = random_num
        self.department_id = random_num
        self.role_id = random_num
        self.device_id = random_num
        self.no = random_num
        self.terminal_no = random_num
        self.user_role_id = random_num
        self.role_menu_id = random_num
        self.menu_id = random_num
        self.capital_id = random_num
        self.alarm_id = random_num
        self.work_order_id = random_num
        self.task_id = random_num

        self.mysql_conn = Mysql_connet()
    ...
    def inser_user(self):
        ...
        self.mysql_conn.insert_sql("INSERT INTO `t_user_role` VALUES ({}, {}, {})".format(self.user_role_id, self.role_id, self.user_id))
        self.mysql_conn.insert_sql("INSERT INTO `t_role` VALUES ({}, '普通管理员', '普通管理员', 0, '2021-06-24 09:21:03', 1377074593995628546, '2021-06-24 09:22:11', NULL)".format(self.role_id))
        self.mysql_conn.insert_sql("INSERT INTO `t_role_menu` VALUES ({}, {}, 10)".format(self.role_menu_id, self.role_id))

    def delete_user(self):
        self.mysql_conn.insert_sql("delete from t_department where id={}".format(self.department_id))
        self.mysql_conn.insert_sql("delete from t_role where id={}".format(self.role_id))
        self.mysql_conn.insert_sql("delete from t_role_menu where id={}".format(self.role_menu_id))
        self.mysql_conn.insert_sql("delete from t_user where where id={}".format(self.user_id))
        self.mysql_conn.insert_sql("delete from t_user_role where id={}".format(self.user_role_id))

    def inser_device(self):
        ...
        self.mysql_conn.insert_sql("INSERT INTO `t_capital` VALUES ({}, {}, 0, {}, '系统', '', '', NULL, NULL, NULL, 0, NULL, '2021-06-11 17:44:36', NULL, NULL)".format(self.device_id, self.terminal_no, self.department_id))
        ...
        self.mysql_conn.insert_sql("INSERT INTO `t_cellar_well_control_log` VALUES (1403295756407812097, {}, 0, '2021-06-11 18:19:15')".format(self.terminal_no))
        self.mysql_conn.insert_sql("INSERT INTO `t_cellar_well_sensor` VALUES (1403287188904357889, {}, 90, 20, 10, 0, 'V1.0', 'V1.0', 0, 0, 0, '2021-06-11 17:45:12', '0', 0, NULL, 20, 30)".format(self.terminal_no))
        self.mysql_conn.insert_sql("INSERT INTO `t_device_alarm` VALUES ({}, {}, 51, 0, 0, '2021-06-18 16:44:02', NULL, NULL, 0)".format(self.alarm_id, self.terminal_no))
        self.mysql_conn.insert_sql("INSERT INTO `t_push_message` VALUES (1403288965368262658, {}, {}, NULL, '2021-06-11 17:52:15', '2021-06-11 17:52:16', 1, NULL, 0)".format(self.alarm_id, self.user_id))
        self.mysql_conn.insert_sql("INSERT INTO `t_push_set` VALUES (1403288766956711938, {}, {}, '8', 0, 1, 1, '2021-06-11 17:51:29', 1377074593995628546)".format(self.user_id, self.department_id))
        self.mysql_conn.insert_sql("INSERT INTO `t_task` VALUES (1403291589383565314, {}, 0, '2021-06-11 18:02:41', 1377074593995628546, 1377074593995628546, 0, '1,21,3', 6, 0, NULL, '告警后立即触发', 0, 1)".format(self.department_id))
    ...
    def delete_device(self):
        self.mysql_conn.delete_sql("delete from t_cellar_well where id={}")
        self.mysql_conn.delete_sql("delete from t_capital where id={}")
        self.mysql_conn.delete_sql("delete from t_images where id={}")
        self.mysql_conn.delete_sql("delete from t_cellar_well_terminal where id={}")
        self.mysql_conn.delete_sql("delete from t_cellar_well_control_log where id={}")
        self.mysql_conn.delete_sql("delete from t_cellar_well_sensor where id={}")
        self.mysql_conn.delete_sql("delete from t_device_alarm where id={}")
        self.mysql_conn.delete_sql("delete from t_push_message where id={}")
        self.mysql_conn.delete_sql("delete from t_push_set where id={}")
        self.mysql_conn.delete_sql("delete from t_task where id={}")
        self.mysql_conn.delete_sql("delete from t_work_order where id={}")
        self.mysql_conn.delete_sql("delete from t_device_param where id={}")
