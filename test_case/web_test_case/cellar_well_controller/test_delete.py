...
class Test_Detele_Device(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.in_mysql = cls.mysql.select_sql(
            'select is_delete from t_cellar_well where no="888888801"')
        ...
        cls.device_id = cls.mysql.select_sql(
            'select id from t_cellar_well where no="888888801"')
    ...
    def test_delete_device_success(self):
        ...
        self.assertEqual(0,self.in_mysql,'数据库未删除，删除窖井用例执行失败')
